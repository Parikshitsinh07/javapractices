...
<html lang="en">
  ...
  <body  onload="myFunction()">
    <section id="products1" class="section-p1" style="margin-top: -40px;">
      <p style="font-size: 40px;">Discount Books</p>
      <p>Best Discounts for Books</p>
      <div class="pro-container">
        <div class="pro">
          ...
          <a href="Add.jsp" target="_blank"><i class="fal fa-shopping-cart cart"></i></a>
        </div>
        <div class="pro">
