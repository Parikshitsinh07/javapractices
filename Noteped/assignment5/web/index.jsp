<%-- 
    Document   : index
    Created on : 2 Mar, 2024, 6:36:21 PM
    Author     : AM
--%>
            ...
            <form onsubmit="return validate()" action="insert_data" method="post">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="sc" id="sc"placeholder="Course"></td>
                </tr>
                
                <tr>
                    <td colspan="2"><button type="submit" name="insert" value="insert">insert</button></td>
